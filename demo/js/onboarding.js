...
for(var i=1;i<=4;i++){document.getElementById('step'+i).style.display='none';document.getElementById('step'+i).classList.remove('active');document.getElementById('dot'+i).classList.remove('active');}
...
var el=document.getElementById('onboardTestResult');
if(r.alive){el.textContent='Online ('+r.latencyMs+' ms)';el.style.color='#4ade80';}
else{el.textContent='Down';el.style.color='#f87171';}
