...
// --- Alert Channels CRUD ---
router.get('/api/alerts/channels', async (req, res) => {
...
router.post('/api/alerts/channels', async (req, res) => {
...
router.put('/api/alerts/channels/:id', async (req, res) => {
...
router.delete('/api/alerts/channels/:id', async (req, res) => {
  await dbRun('DELETE FROM alert_channels WHERE id = ?', [req.params.id]);
  res.json({ ok: true });
});

router.post('/api/alerts/channels/:id/test', async (req, res) => {
...
router.put('/api/alerts/rules/:deviceId', async (req, res) => {
...
// --- Alert Log ---
router.get('/api/alerts/log', async (req, res) => {
