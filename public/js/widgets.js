...
var el=document.getElementById('pluginWidgets');if(!d.length){el.textContent='No plugins.';return;}
...
if(!mx)mx=100;var bw=w/d.length;
for(var j=0;j<d.length;j++){var l=(d[j].live&&d[j].live.latencyMs)||0,bh=(l/mx)*(h-20),x=j*bw,y=h-bh-10;
